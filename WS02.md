...
Starting from now, we're going to have to work across two browser tabs: this workshop page and your codesandbox project. After each major step, we'll show expandable sections with example solutions inside so you can see an example solution, and make sure your code in your own sandbox matches up.
 ...
 - Please create a new vanilla codesandbox below, you can do this on your own `dashboard` on codesandbox. Go and give that a try using your new account. 😀
...
If this doesn't happen in your sandbox, use the expandable sections below to check how your code differs from the provided example solutions. We won't always provide complete solutions like this, but we're going easy in these first couple of sessions 😀
...
Here's a sandbox which should match where we got to after completing all task 3 steps
