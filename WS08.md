...
[Here is a pretty nifty little site that can help with finding which key codes to use...](https://keycode.info/)
...
The great Daniel Shiffman has some really well described [videos about collision detection on youtube](https://www.youtube.com/watch?v=uAfw-ko3kB8), albeit in 2D. We'd recommend watching 7.6 and 7.7 if some of this is still unclear...
