...
# Here is the starting point codesandbox we created:
...
Click on the "Open Sandox" button in the bottom right hand corner of the *starting point* above and it will open up a new tab with that sandbox ready for you to work in. 😀 You can then click the "fork" button in the top right hand corner which will automatically create a new project with this template as a starting point.
